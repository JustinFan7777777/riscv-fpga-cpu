...
HD_PWD='D:/Code/riscv-fpga-cpu/cpu_project/cpu_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopDebug.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopDebug.tcl
