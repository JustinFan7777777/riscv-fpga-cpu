...
HD_PWD='D:/Code/riscv-fpga-cpu/cpu_project/cpu_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopDebug.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopDebug.tcl -notrace
